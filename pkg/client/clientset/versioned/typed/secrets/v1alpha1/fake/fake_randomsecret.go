...
var randomsecretsResource = schema.GroupVersionResource{Group: "secrets.k8s.captncraig.io", Version: "v1alpha1", Resource: "randomsecrets"}

var randomsecretsKind = schema.GroupVersionKind{Group: "secrets.k8s.captncraig.io", Version: "v1alpha1", Kind: "RandomSecret"}
...
func (c *FakeRandomSecrets) Get(name string, options v1.GetOptions) (result *v1alpha1.RandomSecret, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(randomsecretsResource, c.ns, name), &v1alpha1.RandomSecret{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.RandomSecret), err
}
...
func (c *FakeRandomSecrets) List(opts v1.ListOptions) (result *v1alpha1.RandomSecretList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(randomsecretsResource, randomsecretsKind, c.ns, opts), &v1alpha1.RandomSecretList{})
	...
	list := &v1alpha1.RandomSecretList{ListMeta: obj.(*v1alpha1.RandomSecretList).ListMeta}
	for _, item := range obj.(*v1alpha1.RandomSecretList).Items {
...
func (c *FakeRandomSecrets) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(randomsecretsResource, c.ns, opts))
...
func (c *FakeRandomSecrets) Create(randomSecret *v1alpha1.RandomSecret) (result *v1alpha1.RandomSecret, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(randomsecretsResource, c.ns, randomSecret), &v1alpha1.RandomSecret{})
...
func (c *FakeRandomSecrets) Update(randomSecret *v1alpha1.RandomSecret) (result *v1alpha1.RandomSecret, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(randomsecretsResource, c.ns, randomSecret), &v1alpha1.RandomSecret{})
...
func (c *FakeRandomSecrets) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(randomsecretsResource, c.ns, name), &v1alpha1.RandomSecret{})
...
func (c *FakeRandomSecrets) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.RandomSecret, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(randomsecretsResource, c.ns, name, pt, data, subresources...), &v1alpha1.RandomSecret{})
