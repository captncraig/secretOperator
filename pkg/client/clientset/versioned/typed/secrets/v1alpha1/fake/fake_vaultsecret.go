...
var vaultsecretsResource = schema.GroupVersionResource{Group: "secrets.k8s.captncraig.io", Version: "v1alpha1", Resource: "vaultsecrets"}

var vaultsecretsKind = schema.GroupVersionKind{Group: "secrets.k8s.captncraig.io", Version: "v1alpha1", Kind: "VaultSecret"}
...
func (c *FakeVaultSecrets) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(vaultsecretsResource, c.ns, opts))
...
func (c *FakeVaultSecrets) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.VaultSecret, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(vaultsecretsResource, c.ns, name, pt, data, subresources...), &v1alpha1.VaultSecret{})
