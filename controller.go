...
func NewController(
	...
	fooInformer informers.RandomSecretInformer) *Controller {
...
func (c *Controller) updateFooStatus(foo *secretsv1alpha1.RandomSecret, deployment *appsv1.Deployment) error {
